    ...
    <>
      ...
      <main className="page page-work">
        <div className="page-content">
          <h4 className="text-xl font-semibold">Career Highlights ✨</h4>
          <ul>
            <li>A decade of experience in programming and building apps with Javascript and web technologies</li>
            <li>Co founded 2 startups and took them from zero to production</li>
          ...
          <h4 className="text-xl font-semibold mt-6">About Me 😎</h4>
          ...
          <h4 className="text-xl font-semibold mt-6">Professional Experience 👨‍💻</h4>
          ...
          <h4 className="text-xl font-semibold mt-6">Startups 🚀</h4>
          <div className="flex mt-2 items-center">
            <h6 className="font-semibold">Notebase Technologies LLP</h6>
            <small className="ml-1">(1.5yrs)</small>
          </div>
          <ul>
            <li>Founder - <small className="ml-1">Nov 2020 - Feb 2022</small></li>
          </ul>
          <p className="mt-2">Built a blogging platform based on graph based note taking.</p>
          ...
          <ul>
            <li>Co Founder - <small className="ml-1">Dec 2014 - Aug 2022</small></li>
          </ul>
